...
lv_obj_t * lv_demo_music_main_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_grid_cell(icon_box, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 3, 1);
    lv_obj_set_grid_cell(spectrum_obj, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 4, 1);
    lv_obj_set_grid_cell(ctrl_box, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 5, 1);
...
static void lv_create_msgbox(void)
{
    ...
    /* setting fixed size */
    lv_obj_set_size(setting, 200, 150);

    /* setting's titlebar/header */
    //lv_msgbox_add_title(setting, "Volume Setting");
    ...
    lv_label_set_text(lb_brightness, "Volume : ");
    lv_obj_t * slider_brightness = lv_slider_create(cont_brightness);
    lv_obj_set_width(slider_brightness, lv_pct(100));

    int32_t vol= (int32_t)get_audio_volume();
    lv_slider_set_value(slider_brightness, vol, LV_ANIM_OFF);
