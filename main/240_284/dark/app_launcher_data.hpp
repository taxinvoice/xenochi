...
constexpr ESP_Brookesia_AppLauncherIconData_t ESP_BROOKESIA_PHONE_240_284_DARK_APP_LAUNCHER_ICON_DATA()
{
    return {
        .main = {
            .size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(120),
            .layout_row_pad = 10,
        },
        .image = {
            .default_size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(80),
            .press_size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(70),
        },
        .label = {
...
constexpr ESP_Brookesia_AppLauncherData_t ESP_BROOKESIA_PHONE_240_284_DARK_APP_LAUNCHER_DATA()
{
    return {
        .main = {
            .y_start = 0,
        ...
        .icon = ESP_BROOKESIA_PHONE_240_284_DARK_APP_LAUNCHER_ICON_DATA(),
        .flags = {
